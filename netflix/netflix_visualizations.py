...
# NFLX.csv - Monthly
# DJI.csv - Monthly 
# NFLX_daily_by_quarter.csv - Daily
# two files are monthly, one has the whole year daily. 
# the quarterly file has an additional quarter
...
ax.ylabel = 'Closing Stock Price'
ax.xlabel = 'Business Quarters in 2017'
plt.show()
...
# earnings is trending but slower than revenue
# roughly 0.2%
...
ax2.set_xticklabels(dowjones_stocks['Date'],rotation=-80)
ax2.grid(ls = 'dotted')
